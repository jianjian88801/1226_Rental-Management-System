<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="房屋特点" prop="fangwutedian">
          <el-input v-model="ruleForm.fangwutedian" 
              placeholder="房屋特点" clearable  :readonly="ro.fangwutedian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="房屋特点" prop="fangwutedian">
              <el-input v-model="ruleForm.fangwutedian" 
                placeholder="房屋特点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成交量" prop="chengjiaoliang">
          <el-input v-model="ruleForm.chengjiaoliang" 
              placeholder="成交量" clearable  :readonly="ro.chengjiaoliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成交量" prop="chengjiaoliang">
              <el-input v-model="ruleForm.chengjiaoliang" 
                placeholder="成交量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.fangwuzhaopian" label="房屋照片" prop="fangwuzhaopian">
          <file-upload
          tip="点击上传房屋照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.fangwuzhaopian?ruleForm.fangwuzhaopian:''"
          @change="fangwuzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.fangwuzhaopian" label="房屋照片" prop="fangwuzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fangwuzhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="房屋介绍" prop="fangwujieshao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fangwujieshao" label="房屋介绍" prop="fangwujieshao">
                    <span>{{ruleForm.fangwujieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	fangwutedian : false,
	fangwujieshao : false,
	chengjiaoliang : false,
	zulinjiage : false,
	xiangqing : false,
	fangwuzhaopian : false,
	wuzhuzhanghao : false,
	wuzhuxingming : false,
	lianxidianhua : false,
	sfsh : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fangwuzhuangtai = true;
          ...
          if(o=='fangwutedian'){
            this.ruleForm.fangwutedian = obj[o];
	    this.ro.fangwutedian = true;
            continue;
          }
          if(o=='fangwujieshao'){
	    ...
	    this.ro.fangwujieshao = true;
          ...
          if(o=='chengjiaoliang'){
            this.ruleForm.chengjiaoliang = obj[o];
	    this.ro.chengjiaoliang = true;
            continue;
          }
          if(o=='zulinjiage'){
	    ...
	    this.ro.xiangqing = true;
          ...
          if(o=='fangwuzhaopian'){
            this.ruleForm.fangwuzhaopian = obj[o];
	    this.ro.fangwuzhaopian = true;
            continue;
          }
          if(o=='wuzhuzhanghao'){
      ...
      this.$http({
		...
		if(json.lianxidianhua!=''&&json.lianxidianhua){
          ...
          this.$message.error(data.msg);
            ...
            this.fangwuzhuangtaiOptions = "已出租,未出租".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springboot94sk3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    fangwuzhaopianUploadChange(fileUrls) {
	this.ruleForm.fangwuzhaopian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
