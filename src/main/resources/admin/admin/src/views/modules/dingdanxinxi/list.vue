<template>
  <div class="main-content">
      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '房屋地址' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.fangwudizhi" placeholder="房屋地址" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.fangwudizhi" placeholder="房屋地址" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.fangwudizhi" placeholder="房屋地址" clearable></el-input>
                </el-form-item>
          <el-form-item>
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('dingdanxinxi','发布评价') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="zukepingjiaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'发布评价':'' }}</el-button>
                <el-button v-if="isAuth('dingdanxinxi','发布评价') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="zukepingjiaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'发布评价':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('dingdanxinxi','发布评价') && contents.tableBtnIcon == 0" type="success" size="mini" @click="zukepingjiaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'发布评价':'' }}</el-button>
    ...
    <zukepingjia-cross-add-or-update v-if="zukepingjiaCrossAddOrUpdateFlag" :parent="this" ref="zukepingjiaCrossaddOrUpdate"></zukepingjia-cross-add-or-update>
...
import zukepingjiaCrossAddOrUpdate from "../zukepingjia/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      zukepingjiaCrossAddOrUpdateFlag: false,
  ...
  methods: {
    ...
    zukepingjiaCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.zukepingjiaCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','dingdanxinxi');
      this.$nextTick(() => {
      this.$refs.zukepingjiaCrossaddOrUpdate.init(row.id,type);
      });
    },
    payHandler(row){
